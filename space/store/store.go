// Package store defines the append-only event log that backs an n-dimensional
// engine. It is the n-dimensional counterpart of the root store package: the
// same contracts, but over space/op.Op instead of the 1-D op.Op.
package store
